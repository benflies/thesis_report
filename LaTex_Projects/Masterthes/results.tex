...
\begin{figure}[!tbp]
  \centering
  \subfloat[hpx_csc_fastqc]{\includegraphics[width=0.45\textwidth]{fastq_halo_forward.png}\label{fig:amp_dist_hpx}}
  \hfill
  \subfloat[tst15_fastqc]{\includegraphics[width=0.45\textwidth]{fastq_tst15_forward.png}\label{fig:amp_dist_tst}}
